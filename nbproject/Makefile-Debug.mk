...
${OBJECTDIR}/banco/dominio/Banco.o: banco/dominio/Banco.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/banco/dominio/Banco.o banco/dominio/Banco.cpp

${OBJECTDIR}/banco/dominio/Cliente.o: banco/dominio/Cliente.cpp
	${MKDIR} -p ${OBJECTDIR}/banco/dominio
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/banco/dominio/Cliente.o banco/dominio/Cliente.cpp

${OBJECTDIR}/banco/dominio/Conta.o: banco/dominio/Conta.cpp
	${MKDIR} -p ${OBJECTDIR}/banco/dominio
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/banco/dominio/Conta.o banco/dominio/Conta.cpp

${OBJECTDIR}/banco/dominio/ContaCorrente.o: banco/dominio/ContaCorrente.cpp
	${MKDIR} -p ${OBJECTDIR}/banco/dominio
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/banco/dominio/ContaCorrente.o banco/dominio/ContaCorrente.cpp

${OBJECTDIR}/banco/dominio/ContaPoupanca.o: banco/dominio/ContaPoupanca.cpp
	${MKDIR} -p ${OBJECTDIR}/banco/dominio
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/banco/dominio/ContaPoupanca.o banco/dominio/ContaPoupanca.cpp

${OBJECTDIR}/banco/relatorios/RelatorioClientes.o: banco/relatorios/RelatorioClientes.cpp
	${MKDIR} -p ${OBJECTDIR}/banco/relatorios
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/banco/relatorios/RelatorioClientes.o banco/relatorios/RelatorioClientes.cpp
